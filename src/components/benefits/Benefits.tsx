...
const benefits = [
  {
    ...
    description: 'Coleção completa de gatinhos amigurumi fofos com instruções detalhadas'
  },
  {
    emoji: '⚡',
  ...
  },
  {
    ...
    description: 'Gatinhos amigurumi são tendência absoluta e possuem alto valor de mercado'
  },
  {
    emoji: '🤝',
    ...
    <section className="py-20 px-5 bg-white">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-[32px] font-bold text-cinza-dark text-center mb-6">
          Por que a "Apostila Amigurumi Gatinhos Fofos" é tudo que você precisa?
        </h2>
