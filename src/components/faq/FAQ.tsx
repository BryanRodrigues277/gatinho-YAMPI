...
const faqs = [
  ...
  {
    question: 'Quantos modelos de gatinhos amigurumi estão incluídos?',
    answer: 'Você vai receber um total de 16 receitas completas: diversos modelos de gatinhos fofos e acessórios. Tudo isso acompanhado de gráficos claros e dicas detalhadas.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Sim, sua compra estará 100% segura. Utilizamos protocolo https em parceria com a Hotmart, a maior plataforma de infoprodutos da América Latina.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Sim, o valor promocional de $9.90 é para tornar o kit acessível ao maior número de pessoas possível. Mas atenção: essa é uma oferta limitada e pode acabar a qualquer momento.'
  }
];
